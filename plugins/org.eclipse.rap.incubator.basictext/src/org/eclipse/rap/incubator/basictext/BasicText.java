...
public class BasicText extends Composite {
	...
	private static final long serialVersionUID = -7774257380707131214L;

	static final Logger logger = Logger.getLogger(BasicText.class);
	
	private static final String REMOTE_TYPE = "org.eclipse.rap.incubator.BasicText";
	...
	protected void setupClient() {
		...
		addBaseResource(new Path("org/eclipse/rap/incubator/basictext/ace/ext-language_tools.js"));
		addBaseResource(new Path("org/eclipse/rap/incubator/basictext/ace/ext-tooltip.js"));
		addBaseResource(new Path("org/eclipse/rap/incubator/basictext/ace/theme-basic.js"));
		addBaseResource(new Path("org/eclipse/rap/incubator/basictext/global-index.js"));
