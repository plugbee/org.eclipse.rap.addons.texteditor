...
public class Activator extends AbstractUIPlugin {
	...
	public static final String LANGUAGE_NAME = "org.eclipse.rap.incubator.texteditor.Html";

	// The plug-in ID
	public static final String PLUGIN_ID = "org.eclipse.rap.incubator.texteditor.html"; //$NON-NLS-1$
	...
	protected void initializeImageRegistry(ImageRegistry reg) {
		addImageFilePath(HtmlImageProvider.FILE);
		addImageFilePath(HtmlImageProvider.WIZARD);
	}
