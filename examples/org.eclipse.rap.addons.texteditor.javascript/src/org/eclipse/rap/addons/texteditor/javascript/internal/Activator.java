 ...
 * </copyright>
 */
package org.eclipse.rap.addons.texteditor.javascript.internal;
...
public class Activator extends AbstractUIPlugin {
	...
	// The plug-in ID
	public static final String PLUGIN_ID = "org.eclipse.rap.addons.texteditor.javascript"; //$NON-NLS-1$
	...
	protected void initializeImageRegistry(ImageRegistry reg) {
		addImageFilePath(JavascriptImageProvider.FILE);
		addImageFilePath(JavascriptImageProvider.WIZARD);
	}
