 ...
 * </copyright>
 */
package org.eclipse.rap.addons.texteditor.javascript.widget;
...
public class Javascript extends BasicText {
	...
	public static final String REMOTE_TYPE = "org.eclipse.rap.addons.texteditor.javascript.widget.Javascript";
	...
	protected void setupClient() {
		...
		languageResources.add(new Path("src-js/org/eclipse/rap/addons/texteditor/javascript/ace/mode-javascript.js"));
		languageResources.add(new Path("src-js/org/eclipse/rap/addons/texteditor/javascript/ace/worker-javascript.js"));
