...
(function() {
	rap.registerTypeHandler("org.eclipse.rap.addons.texteditor.javascript.widget.Javascript", {
		factory : function(properties) {
			return new org.eclipse.rap.addons.texteditor.javascript.widget.Javascript(properties);
		},	
		destructor : "destroy",	 
	...
	rwt.qx.Class.define("org.eclipse.rap.addons.texteditor.javascript.widget.Javascript", {
		...
		members : {
			...
			createEditor : function() {
				...
				var workerPath = 'rwt-resources/src-js/org/eclipse/rap/addons/texteditor/javascript/ace';
				ace.require("ace/config").set("workerPath", workerPath);
				var themePath = 'rwt-resources/src-js/org/eclipse/rap/addons/texteditor/javascript/ace';
