 ...
 * </copyright>
 */
package org.eclipse.rap.incubator.texteditor.css;

import org.apache.log4j.Logger;
import org.eclipse.rap.incubator.basictext.BasicText;
import org.eclipse.rap.incubator.texteditor.BasicTextEditor;
import org.eclipse.rap.incubator.texteditor.css.widget.Css;
import org.eclipse.swt.SWT;
import org.eclipse.swt.layout.GridData;
import org.eclipse.swt.widgets.Composite;

public class CssEditor extends BasicTextEditor {

	static final Logger logger = Logger.getLogger(CssEditor.class);
	...
	protected BasicText createTextWidget(Composite parent, int style) {
		Css textWidget = new Css(parent, style);
