 ...
 * </copyright>
 */
package org.eclipse.rap.addons.texteditor.json.widget;
...
public class Json extends BasicText {
	...
	public static final String REMOTE_TYPE = "org.eclipse.rap.addons.texteditor.json.widget.Json";
	...
	protected void setupClient() {
		...
		languageResources.add(new Path("src-js/org/eclipse/rap/addons/texteditor/json/ace/mode-json.js"));
		languageResources.add(new Path("src-js/org/eclipse/rap/addons/texteditor/json/ace/worker-json.js"));
