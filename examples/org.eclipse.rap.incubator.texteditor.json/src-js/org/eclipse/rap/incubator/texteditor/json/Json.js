	...
	rwt.qx.Class.define("org.eclipse.rap.incubator.texteditor.json.widget.Json", {
		...
		members : {
			...
			createEditor : function() {
				...
				var workerPath = 'rwt-resources/src-js/org/eclipse/rap/incubator/texteditor/json/ace';
				ace.require("ace/config").set("workerPath", workerPath);
				var themePath = 'rwt-resources/src-js/org/eclipse/rap/incubator/texteditor/json/ace';
