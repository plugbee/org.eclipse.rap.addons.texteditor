 ...
 * </copyright>
 */
package org.eclipse.rap.incubator.texteditor.json.internal;
...
public class Activator extends AbstractUIPlugin {
	...
	// The plug-in ID
	public static final String PLUGIN_ID = "org.eclipse.rap.incubator.texteditor.json"; //$NON-NLS-1$
	...
	protected void initializeImageRegistry(ImageRegistry reg) {
		addImageFilePath(JsonImageProvider.FILE);
		addImageFilePath(JsonImageProvider.WIZARD);
	}
