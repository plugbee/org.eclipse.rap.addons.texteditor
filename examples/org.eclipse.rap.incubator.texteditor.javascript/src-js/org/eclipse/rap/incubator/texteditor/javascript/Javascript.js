 ...
 */
(function() {
	rap.registerTypeHandler("org.eclipse.rap.incubator.texteditor.javascript.widget.Javascript", {
		factory : function(properties) {
			return new org.eclipse.rap.incubator.texteditor.javascript.widget.Javascript(properties);
		},
		destructor : "destroy",
	...
	rwt.qx.Class.define("org.eclipse.rap.incubator.texteditor.javascript.widget.Javascript", {
		...
		members : {
			...
			createEditor : function() {
				...
				var themePath = 'rwt-resources/src-js/org/eclipse/rap/incubator/texteditor/javascript';
				...
				if (editor != null) {
			        ...
			        try {
			        	...
			        	alert("A problem occured when setting javascript mode from " + "https://cdnjs.cloudflare.com/ajax/libs/ace/1.2.4/");
			        }
