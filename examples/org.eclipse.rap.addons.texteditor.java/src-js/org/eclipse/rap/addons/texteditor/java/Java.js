...
(function() {
	rap.registerTypeHandler("org.eclipse.rap.addons.texteditor.java.widget.Java", {
		factory : function(properties) {
			return new org.eclipse.rap.addons.texteditor.java.widget.Java(properties);
		},	
		destructor : "destroy",	 
	...
	rwt.qx.Class.define("org.eclipse.rap.addons.texteditor.java.widget.Java", {
		...
		members : {
			...
			createEditor : function() {
				...
				var workerPath = 'rwt-resources/src-js/org/eclipse/rap/addons/texteditor/java/ace';
				ace.require("ace/config").set("workerPath", workerPath);
				var themePath = 'rwt-resources/src-js/org/eclipse/rap/addons/texteditor/java/ace';
